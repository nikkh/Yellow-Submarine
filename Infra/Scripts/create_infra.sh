...
dirAclStorageAccountName="$applicationName$RANDOM"diracls
...
az eventhubs eventhub create -g $resourceGroupName --namespace-name $resultsEventHubNamespace --name $resultsHub --message-retention 4 --partition-count 4
